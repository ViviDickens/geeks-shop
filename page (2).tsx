...
export default function ProductDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="container" style={{ padding: '48px 24px' }}>
      {/* Breadcrumb */}
      <nav data-testid="breadcrumb" style={{
        marginBottom: '32px',
        fontSize: '13px',
      ...
      <div style={{
        ...
        <div>
          ...
          <h1 data-testid="product-detail-name" style={{
          ...
          <div data-testid="product-detail-rating" style={{ marginBottom: '16px' }}>
            ...
            <span style={{ color: 'var(--text-muted)', fontSize: '13px', marginLeft: 8 }}>
              {product.rating} / 5.0
            </span>
          </div>

          <div data-testid="product-detail-price" style={{
            fontFamily: 'var(--font-display)',
            fontSize: '36px',
            fontWeight: 900,
          ...
          <p data-testid="product-detail-description" style={{
          ...
          {/* Stock status */}
          <p data-testid="product-detail-stock" style={{
            marginBottom: '24px',
            fontSize: '14px',
          ...
          {product.stock > 0 && (
            <div style={{ display: 'flex', gap: '16px', alignItems: 'center', marginBottom: '24px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <span data-testid="qty-value" style={{
                  fontFamily: 'var(--font-display)',
                  fontSize: '18px',
                  minWidth: '32px',
                  textAlign: 'center'
